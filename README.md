...
<img width="1332" height="762" alt="Image" src="https://github.com/user-attachments/assets/4810a498-36ba-4302-af9d-1fbaf0d59912" />

| 메트릭 | 결과 |
| :--- | :--- |
| **요청 95% 응답 시간 (p(95))** | **`12.81s`** (12,810ms) |
| **초당 요청 수 (TPS)** | `6.86/s` |
...
<img width="1302" height="783" alt="Image" src="https://github.com/user-attachments/assets/d849649e-13df-4bea-b891-02687f16d8a4" />

| 메트릭 | 결과 |
| :--- | :--- |
| **요청 95% 응답 시간 (p(95))** | **`10.72s`** (800ms) |
| **초당 요청 수 (TPS)** | `8.48/s` |
| **요청 실패율** | `0%` |
...
| :--- | :---: | :---: | :---: |
| **p(95) 응답 시간** | `12.81s` | `10.72s` | **약 16.3% 개선** |
| **초당 요청 수 (TPS)** | `6.86/s` | `8.48/s` | **약 1.24배 (23.6%) 향상** |

`@EntityGraph`를 통한 Fetch Join 적용으로 N+1 쿼리 문제를 해결한 결과, API의 응답 속도는 **16% 이상 개선**되었고, 서버가 초당 처리할 수 있는 요청량(TPS)은 **1.24배 이상** 증가했습니다.
